...
class FormFieldCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'identificationData.entity' => 'nullable|exists:entities,slug',
    ...
    public function messages(): array
    {
        return [
            ...
            'formFields.type.in' => 'The type must be one of the following: text, select, textarea, file, radio, checkbox.',
            ...
            'formFields.isRequired.required' => 'The required field is required.',
            'formFields.isRequired.in' => 'The required field must be either true or false.',
