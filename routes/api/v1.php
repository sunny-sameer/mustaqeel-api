...
Route::group(['middleware' => ['auth:sanctum','role:admin|super-admin']], function () {
    Route::prefix('admin')->group(function () { // Categories
        ...
        Route::post('sectors/{id}/categories', [GenericController::class, 'attachCategoriesToSector']);
        ...
        Route::post('activities/{id}/entities', [GenericController::class, 'attachEntitiesToActivity']);
